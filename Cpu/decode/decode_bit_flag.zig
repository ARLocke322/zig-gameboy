...
pub fn decode_BIT_u3_r8(cpu: *Cpu, ix: u3, register_number: u3) void {
...
pub fn decode_RES_u3_r8(cpu: *Cpu, ix: u3, register_number: u3) void {
    const opts = helpers.get_r8(cpu, register_number);
    if (opts.isHL) {
...
pub fn decode_SET_u3_r8(cpu: *Cpu, ix: u3, register_number: u3) void {
    const opts = helpers.get_r8(cpu, register_number);
    if (opts.isHL) {
