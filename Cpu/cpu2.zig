...
pub const Cpu = struct {
    ...
    pub fn decode_execute(self: *Cpu, instruction: u8) void {
        ...
        switch (instruction) {
            0x00 => {},
            0x01, 0x11, 0x21, 0x31 => x_ld.execute_LD_r16_n16(
                self,
    ...
    pub fn get_r8(self: *Cpu, index: u2) struct { reg: *Register, isHi: bool, isHL: bool } {
        return switch (index) {
            0 => .{ &self.BC, true, false },
            1 => .{ &self.BC, false, false },
            2 => .{ &self.DE, true, false },
            3 => .{ &self.DE, false, false },
            4 => .{ &self.HL, true, false },
            5 => .{ &self.HL, false, false },
            6 => .{ &self.HL, false, true },
            7 => .{ &self.AF, true, false },
        };
    }
